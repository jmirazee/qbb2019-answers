...
model = sm.formula.ols(formula="log_FPKM ~ H3K4me3_mean + H3K4me1_mean + H3K9me3_mean", data=df_fpkms_merge)
...
ax.set_title('Residuals from log_FPKM-mark Model')
fig.savefig('lunch_pt_6_residuals_log_FPKM_mark_hist.png')
plt.close(fig)
